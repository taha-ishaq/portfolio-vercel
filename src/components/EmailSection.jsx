    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4'>
        ...
        <div>
            <form className='flex flex-col' onSubmit={handleSubmit}>
                ...
                <input name='email' className='bg-[#18191E] border border-[#33353F] placeholde-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' type='email' id='email' required placeholder='Taha@gmail.com' /> 
                </div>
                <div className='mb-6'>
                <label htmlFor='subject' className='text-white block mb-2 text-sm font-medium '>Subject</label>
                <input name='subject'  className='bg-[#18191E] border border-[#33353F] placeholde-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' type='text' id='subject' required placeholder='Just saying Hi' /> 
                </div>
                <div className='mb-6'>
